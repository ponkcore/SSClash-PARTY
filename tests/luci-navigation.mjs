...
assert.match(settings, /Software Updates/);
assert.match(settings, /createPartyUpdateCard/);
assert.match(settings, /createKernelUpdateCard/);
assert.match(settings, /statusSection,\s*softwareUpdatesSection/);
assert.doesNotMatch(settings, /PARTY Software Update/);
assert.doesNotMatch(settings, /Mihomo Kernel Management/);
